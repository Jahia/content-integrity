...
2.3 | 7.2.0.0 | Implemented a sanity check for the "work in progress" related properties<br>Implemented the possibility to define a minimum DX version for an integrity check<br>[bugfix]Fixed the execution conditions on MarkedForDeletionCheck
...
2.7 | 7.3.0.0 | Added the possibility to configure some integrity checks