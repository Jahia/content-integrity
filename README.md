...
2.18 | 7.3.0.0 | <ul><li>PropertyDefinitionsSanityCheck:<ul><li>[bugfix] consider Reference and Weakreference as the same type when comparing the value type with the property type</li></ul></li></ul>