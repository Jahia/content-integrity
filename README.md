...
2.19 | 7.3.0.0 | <ul><li>Reduce the memory footprint of the scan</li><li>[bugfix] Fixed NPE when the error has no extra infos</li><li>[bugfix] Avoid NPE on null errors</li></ul>