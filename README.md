...
2.16 | 7.3.0.0 | Implemented a check on the mandatory properties missing their value(s)<br>Sum up of the check durations at the end of the scan: sort the checks by duration